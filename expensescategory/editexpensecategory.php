...
<div class="content-wrapper">
    <div class="container-fluid">
		<div class="card card-register mx-auto mt-5">
			<div class="card-header">Expenses Category Update</div>
				<div class="card-body">
					<?php
                    ...
                    <form name="myform" action="../controllers/expcatcontroller.php?opn=edit&userid=<?php echo $ub->getUid() ?>&expcatid=<?php echo $expcatid ?>" method="post">
                        <div class="form-group">
							<label>Expenses Category Name</label>
								<input class="form-control" type="text" name="expcatname" value="<?php echo $ecb->getExpcatname() ?>"/>
						</div>
						<div class="form-group">
							<label>Expenses Category Details</label>
								<textarea class="form-control" type="text" name="expcatdetails"><?php echo $ecb->getExpcatdetails() ?></textarea>
						</div>
						<div class="form-group">
